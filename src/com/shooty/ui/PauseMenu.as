package com.shooty.ui 
{
	...
	public class PauseMenu extends Sprite
	{
		...
		{
			mute(!SiteSound.muted)		
		}

		public function mute(value:Boolean, fast:Boolean = false):void{
			if(value)
			{
				bitmap.bitmapData = openMuteBitmapData;
				SiteSound.mute(fast?0:1);
				//trace("muted: true");
			}
			else
			{
		...
		public function pause(value:Boolean, fast:Boolean = false):void{
			paused = value
