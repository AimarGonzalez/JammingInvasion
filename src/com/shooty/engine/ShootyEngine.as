package com.shooty.engine 
{
	...
	import com.shooty.engine.spectrum.MicroManager;
	import com.shooty.engine.spectrum.SpectrumManager;
	...
	public class ShootyEngine extends EventDispatcher
	{
		...
		public var spectrumManager		:SpectrumManager; 		// manages the baddies as they fly down the screen
		public var microManager		:MicroManager; 		// manages the baddies as they fly down the screen
		...
		public function update() : void
		{
			...
			if(isDesktop && isFiring)
			{
				if(!this.shootyView.isHittingPauseButton()){
		...
		private function fire():void{
			...
			if(gunMode == 0 || gunMode == Pickup.SHIELD)
			{
				...
				bulletManager.fireSound.volume = isFiring ? 0.5 : 0;
		...
		private function init() : void
		{
			...
			if(Cnst.MICRO_ENABLED){
				microManager = new MicroManager(this);
			}
			spectrumManager = new SpectrumManager(this);
			
			//preparamos el EnemyManager
			enemyManager = new EnemyManager(this);
			enemyManager.addSpectrumDispatcher(spectrumManager);
